...
### U.S. Covid-19 Vaccination Rate of Each States
...
### The Highest 5 and the lowest 5 Vaccination Rates
...
g + geom_col(aes(x = Household_Income, y = reorder(State_Abbreviations, Household_Income), fill = State_Abbreviations )) +
  ggtitle("6 Highest Income States", subtitle = "Data on Each U.S. State") +
  theme(legend.position="none")

g <- ggplot(data = tail(rate_cases,6)) 
g + geom_col(aes(x = Household_Income, y = reorder(State_Abbreviations, Household_Income), fill = State_Abbreviations )) +
  ggtitle("6 Lowest Income States", subtitle = "Data on Each U.S. State") +
  theme(legend.position="none") +
  scale_x_continuous(limits = c(0,220000))
```
